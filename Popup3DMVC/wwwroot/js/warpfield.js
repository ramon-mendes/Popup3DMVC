...
function CreateWarpField(canvas) {
	// get dimensions of window and resize the canvas to fit
	var width = canvas.parentElement.scrollWidth,
		height = canvas.parentElement.scrollHeight,
		mousex = width / 2,
		mousey = height / 2;
	mousey += 100;
	canvas.width = width;
